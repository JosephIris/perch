...
const sessions: SessionView[] = [
  ...
  // Idle / done, multi-pane — sidebar shows "+142 −38 · ⎇ main ↑2" + breakdown.
  {
    ...
    rootPane: {
      ...
      orientation: "v",
      children: [
        leaf({ name: "log-viewer", agentState: "done", branch: "main", commitCount: 2, linesAdded: 90, linesDeleted: 20, filesChanged: 4, ahead: 2 }),
        leaf({ name: "changelog update", agentState: "done", branch: "main", commitCount: 1, linesAdded: 52, linesDeleted: 18, filesChanged: 3, ahead: 2 }),

...
public class WindowPlacementTests
{
    ...
    private static readonly ScreenRect DualScreen = new(0, 0, 3840, 1080);
    ...
    public void AWindowOnTheSecondMonitorIsRestored()
    {
        ...
        Assert.True(WindowPlacement.IsReachable(new ScreenRect(2000, 100, 1040, 640), DualScreen));
    }
    ...
    public void ThatSameWindowIsRejectedOnceTheMonitorIsGone()
    {
        ...
        Assert.False(WindowPlacement.IsReachable(new ScreenRect(2000, 100, 1040, 640), SingleScreen));
    }
    ...
    public void AWindowStraddlingTwoMonitorsIsFine()
    {
        ...
        Assert.True(WindowPlacement.IsReachable(new ScreenRect(1700, 100, 1040, 640), DualScreen));
    }
    ...
    public void AWindowHangingOffAnEdgeIsKept_ButASliverIsNot()
    {
        ...
        Assert.True(WindowPlacement.IsReachable(new ScreenRect(1500, 100, 1040, 640), SingleScreen));
        // Only a hairline left on screen → you couldn't grab it. Reject.
        Assert.False(WindowPlacement.IsReachable(new ScreenRect(1900, 100, 1040, 640), SingleScreen));
    }
    ...
    public void NegativeCoordinatesWork_ASecondMonitorToTheLEFT()
    {
        ...
        var leftOfPrimary = new ScreenRect(-1920, 0, 3840, 1080);
        Assert.True(WindowPlacement.IsReachable(new ScreenRect(-1500, 100, 1040, 640), leftOfPrimary));
        Assert.False(WindowPlacement.IsReachable(new ScreenRect(-1500, 100, 1040, 640), SingleScreen));
    }
    ...
    public void AWindowAboveTheDesktopIsRejected()
    {
        ...
        Assert.False(WindowPlacement.IsReachable(new ScreenRect(400, -700, 1040, 640), SingleScreen));
    }

    [Fact]
    public void DegenerateRectsAreRejectedRatherThanCrashing()
    {
        Assert.False(WindowPlacement.IsReachable(new ScreenRect(0, 0, 0, 0), SingleScreen));
        Assert.False(WindowPlacement.IsReachable(new ScreenRect(0, 0, 1040, 640), new ScreenRect(0, 0, 0, 0)));
    }
}
